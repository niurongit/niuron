import{G as ve,B as fe,z as ge,x as be,M as g,S as re,R as l,u as v,y as P,v as f,p as a,b as K,s as ce,q as le,C as m,e as Y,d as ye,k as S,m as ie,O as E,g as q,a as oe,n as A,c as H,T as xe,w as Ce,l as ke,i as Se}from"./core-CLxaj8WV.js";import{c as u,n as w,r as d,o as F,U as We}from"./index-DeU6RU-h.js";import"./index-ON1cbb1W.js";import"./index.es-CgxGwOFp.js";const p=be({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Re={state:p,subscribe(s){return ge(p,()=>s(p))},subscribeKey(s,e){return fe(p,s,e)},showTooltip({message:s,triggerRect:e,variant:t}){p.open=!0,p.message=s,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},O=ve(Re),de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await re.isSIWXCloseDisabled()){g.shake();return}g.close()}},$e=v`
  :host {
    display: block;
...
`;var _=function(s,e,t,o){var n=arguments.length,i=n<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(s,e,t,o);else for(var c=s.length-1;c>=0;c--)(r=s[c])&&(i=(n<3?r(i):n>3?r(e,t,i):r(e,t))||i);return n>3&&i&&Object.defineProperty(e,t,i),i};let W=class extends f{constructor(){super(...arguments),this.message="",this.backgroundColor="accent-100",this.iconColor="accent-100",this.icon="info"}render(){return this.style.cssText=`
   ...
   `,a`
    ...
    `}onClose(){K.close()}};W.styles=[P,Ae];_([w()],W.prototype,"message",void 0);_([w()],W.prototype,"backgroundColor",void 0);_([w()],W.prototype,"iconColor",void 0);_([w()],W.prototype,"icon",void 0);W=_([u("wui-alertbar")],W);const Oe=v`
  :host {
    display: block;
    position: absolute;
